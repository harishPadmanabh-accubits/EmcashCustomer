...
class AuthRepository(val context: Context) {
    ...
    fun performSwitchAccount(
        switchAccountRequest: SwitchAccountRequest,
        onApiCallBack: (status: Boolean, response: SwitchAccountResponse.Data?, error: String?) -> Unit
    ): LiveData<ApiMapper<SwitchAccountResponse>> {
    ...
    fun performUserExistCheck(
        userExistCheckRequest: UserExistCheckRequest,
        onApiCallBack: (status: Boolean, response: Boolean?, error: String?) -> Unit
    ): LiveData<ApiMapper<UserExistCheckResponse.Data>> {
    ...
    fun getProfileDetails(): MutableLiveData<ApiMapper<ProfileDetailsResponse.Data>> {
        ...
        api.getProfileDetails().awaitResponse(onSuccess = { response ->
            ...
            profileDetails?.let {
                ...
                syncManager.recentTransactionsCache = it.recentTransactions
