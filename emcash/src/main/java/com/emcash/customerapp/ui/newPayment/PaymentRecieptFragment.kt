...
class PaymentReceiptFragment : Fragment(R.layout.payment_reciept) {
    ...
    private fun renderReceipt(details: TransactionDetailsResponse.Data) {
        ...
        iv_receipient_dp.loadImageWithPlaceHolder(
            details.transferUserInfo.profileImage,
            R.drawable.ic_profile_placeholder
        )
        iv_user_dp_handshake.loadImageWithPlaceHolder(
        ...
        tv_date_time.text =
            toFormattedDate(details.createdAt) + " " + toFormattedTime(details.createdAt.toString())
