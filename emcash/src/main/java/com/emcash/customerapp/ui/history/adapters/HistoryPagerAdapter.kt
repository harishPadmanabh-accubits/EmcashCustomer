...
import com.emcash.customerapp.ui.history.adapters.HistoryPagerAdapter.ViewHolder
...
class HistoryPagerAdapter : PagingDataAdapter<TransactionGroup, ViewHolder>(TransactionsDiffUtil) {
