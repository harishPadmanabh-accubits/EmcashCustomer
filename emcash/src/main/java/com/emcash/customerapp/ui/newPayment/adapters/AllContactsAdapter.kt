...
class AllContactsAdapter(val groupedContactList: ArrayList<GroupedContacts>) :RecyclerView.Adapter<AllContactsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            ...
            rv_contacts.adapter = ContactDetailsAdapter(currentItem.contacts)
        }
    }
